...
public class MyAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public static ScanResultClickListener sScanResultClickListener;
    ...
    public class ViewHolderItem extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public TextView mmcTextView;
        public ViewHolderItem(View view) {
            super(view);
            view.setOnClickListener(this);
            mSsidTextView = view.findViewById(R.id.ssid_text_view);
            mBssidTextView = view.findViewById(R.id.bssid_text_view);
            mdbmTextView = view.findViewById(R.id.dbm_text_view);
            mmcTextView = view.findViewById(R.id.mc_text_view);
        }
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        if (viewHolder instanceof ViewHolderHeader) {
            ...
            viewHolderItem.mmcTextView.setText(currentScanResult.is80211mcResponder()?"@":"x");
        } else {
